...
struct UnitsSession {
    ...
    let ratios: [[Double]] = [[1,0.3048,30.48,0.03108095,0.6818181818], // acceleration
                              ...
                              [1, 1000, 0.083333, 0.0277778, 25.4, 2.54, 0.0254, 0.0000158, 0.0000137,0.0000000254, 254000000, Double(1.697885129e-13), Double(2.684781995E-18) ],//length
    ...
    @State var queryType: String = ""
    @State var selectionUnitCopy = "inch"
